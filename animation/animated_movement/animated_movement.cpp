...
public:
	...
	void Update(int row, float deltaTime,bool faceRight); //deltatime is the time diff between the current frame and the previous frame, we do this to make sure the program runs the same on all computer
